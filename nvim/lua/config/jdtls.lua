local function get_jdtls()
    ...
    elseif SYSTEM:match("darwin") then
        ...
        SYSTEM = "linux" -- WSL sẽ được nhận diện là Linux
    end 
    ...
    local settings = {
        java = {
            ...
            configuration = {
                ...
                workspaceCacheDirectory = vim.fn.expand("~/.cache/jdtls/cache"),
            preferencesDirectory = vim.fn.expand("~/.cache/jdtls/prefs"),
